...
export const workItems: WorkItem[] = [
  {
    ...
    period: "2022 - now",
    roles: [
      { role: "principal engineer", period: "2026 - now" },
      { role: "senior backend engineer", period: "2022 - 2026" },
    ],
    description:
      "creator of sentinel, a copyright detection system used by music generative ai companies like suno.com. originally hired to lead the core engineering team's node.js adoption, which expanded into a zero-downtime migration from a 10+ year old elasticsearch cluster to opensearch, enabling new features and cost savings. in 2025 moved to the product growth engineering team: revamped the api-as-a-service offering unlocking new revenue streams, introduced our first internal mcp implementation for natural language opensearch queries and supporting the development of our music lens ai agent.",
  },
  {
    title: "finleap",
