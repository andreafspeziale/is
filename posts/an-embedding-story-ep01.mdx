...
<img src="/blog/an-embedding-story-ep01/multidimensional-space.svg" alt="Semantically related sentences placed close together in a multidimensional space" style={{maxWidth: '380px', width: '100%', margin: 0}} />
...
<img src="/blog/an-embedding-story-ep01/two-stage-retrieval.svg" alt="Two-stage retrieval using a fast Hamming scan followed by a precise dot-product rescore" style={{maxWidth: '380px', width: '100%', margin: 0}} />
...
<img src="/blog/an-embedding-story-ep01/compression-strategies.svg" alt="Two first-stage compression strategies using the same 128-byte memory budget" style={{maxWidth: '380px', width: '100%', margin: 0}} />
...
<img src="/blog/an-embedding-story-ep01/embedding-pipeline.svg" alt="Embedding pipeline from 17.8 million lyrics through Redis candidate retrieval and precise rescoring" style={{maxWidth: '380px', width: '100%', margin: 0}} />
...
<img src="/blog/an-embedding-story-ep01/parquet-files.svg" alt="Parquet dataset split into 36 files of approximately 500 thousand rows" style={{maxWidth: '380px', width: '100%', margin: 0}} />
...
<img src="/blog/an-embedding-story-ep01/neural-network-flow.svg" alt="A sentence passing through tokenization and neural network layers to become an embedding vector" style={{maxWidth: '380px', width: '100%', margin: 0}} />
